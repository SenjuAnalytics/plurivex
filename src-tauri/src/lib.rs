...
pub fn run() {
    ...
    tauri::Builder::default()
        .invoke_handler(tauri::generate_handler![
            ...
            app::commands::sign_evm_transfer_sealed,
            app::commands::get_evm_address_sealed,
            app::commands::sign_solana_transfer_sealed,
            app::commands::get_solana_address_sealed,
