...
pub const ARB_TOKENS: &[TokenDef] = &[
    ...
    TokenDef { symbol: "DAI", name: "Dai Stablecoin", contract: "0xda10009cbd5d07dd0cecc6616156627511bb9813", decimals: 18 },
    TokenDef { symbol: "WBTC", name: "Wrapped BTC", contract: "0x2f2a2543b76a4166549f7aab2e75bef0aefc5b0f", decimals: 8 },
    TokenDef { symbol: "GMX", name: "GMX", contract: "0xfc5a1a6eb0ba367c0e73da63a5cc324f9f4a2111", decimals: 18 },
];
